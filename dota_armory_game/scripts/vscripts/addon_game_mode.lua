...
require('libraries/animations')                      -- Core lua library
...
require('c_func')                              -- Modular dota_armory script functions
require('npcs/spawnlist')                              -- dota_armory spawn list; needs to be loaded early
