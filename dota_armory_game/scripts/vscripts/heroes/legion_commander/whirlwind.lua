function whirlwind_damage(event)
	...
	if crit_success_bool == true then
		...
		--GameRules:SendCustomMessage("[ Debug ] whirlwind_damage(critical): " .. damage_after_crit, 0, 0)
	else
	end
	...
	if crit_success_bool == false then
		...
		--GameRules:SendCustomMessage("[ Debug ] whirlwind_damage: " .. damage_value, 0, 0)
	else
	end
