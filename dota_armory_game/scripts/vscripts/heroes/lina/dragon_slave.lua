function ds_damage(event)
	...
	if is_this_a_crit == true then
		...
		--GameRules:SendCustomMessage("[ Debug ] ds_damage(critical): " .. damage_after_crit, 0, 0)
		...
		ApplyDamage(damageTable)
		--GameRules:SendCustomMessage("[ Debug ] ds_damage: " .. damage_value, 0, 0)
	end
end