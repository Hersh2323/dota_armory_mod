...
function barebones:PostLoadPrecache()
	...
	PrecacheUnitByNameAsync("npc_dota_operation_candle_blue_ghost", function(...) end)
	PrecacheUnitByNameAsync("npc_dota_armory_gathering_node", function(...) end)
...
function barebones:OnGameInProgress()
    ...
    Timers:CreateTimer(0, -- Start this timer x game-time seconds later
        function()
            if GLOBAL_VARIABLE_ENABLE_GLOBAL_VARIABLE_INFO_TABLE == true then
                --[[
                  print("[ SCALING DEBUG ]--------------------------------------------------------")
                  print("[ SCALING DEBUG ]---------------------[ Info table ]---------------------")
                  print("[ SCALING DEBUG ]--------------------------------------------------------")
                  print("[ SCALING DEBUG ][ GLOBAL_VARIABLE_CURRENT_HERO_LEVEL ][ " .. GLOBAL_VARIABLE_CURRENT_HERO_LEVEL .. " ]")
                  print("[ SCALING DEBUG ][ GLOBAL_VARIABLE_ADDITIONAL_DIFFICULTY_HERO_LEVEL ][ " .. GLOBAL_VARIABLE_ADDITIONAL_DIFFICULTY_HERO_LEVEL .. " ]")
                  print("[ SCALING DEBUG ][ GLOBAL_VARIABLE_ADDITIONAL_HEALTH_PER_LEVEL ][ " .. GLOBAL_VARIABLE_ADDITIONAL_HEALTH_PER_LEVEL .. " ]")
                  print("[ SCALING DEBUG ][ GLOBAL_VARIABLE_MOB_TYPE_HEALTH_MULTIPLIER_MINION ][ " .. GLOBAL_VARIABLE_MOB_TYPE_HEALTH_MULTIPLIER_MINION .. " ]")
                  print("[ SCALING DEBUG ][ GLOBAL_VARIABLE_MOB_TYPE_HEALTH_MULTIPLIER_STANDARD ][ " .. GLOBAL_VARIABLE_MOB_TYPE_HEALTH_MULTIPLIER_STANDARD .. " ]") 
                  print("[ SCALING DEBUG ][ GLOBAL_VARIABLE_MOB_TYPE_HEALTH_MULTIPLIER_ELITE ][ " .. GLOBAL_VARIABLE_MOB_TYPE_HEALTH_MULTIPLIER_ELITE .. " ]")
                  print("[ SCALING DEBUG ][ GLOBAL_VARIABLE_MOB_TYPE_HEALTH_MULTIPLIER_BOSS ][ " .. GLOBAL_VARIABLE_MOB_TYPE_HEALTH_MULTIPLIER_BOSS .. " ]")
                  print("[ SCALING DEBUG ]--------------------------------------------------------")
